...
char* SHA3_256(const char* str, char* sha3, long long length, FILE* file=NULL, bool space=false){
    char *HEX_CHARS = "0123456789abcdef";
    unsigned int PADDING[] = {6, 1536, 393216, 100663296};
    unsigned int SHIFT[] = {0, 8, 16, 24};
    unsigned int RC[] = {1, 0, 32898, 0, 32906, 2147483648, 2147516416, 2147483648, 32907, 0, 2147483649,
        0, 2147516545, 2147483648, 32777, 2147483648, 138, 0, 136, 0, 2147516425, 0, 
        2147483658, 0, 2147516555, 0, 139, 2147483648, 32905, 2147483648, 32771, 
        2147483648, 32770, 2147483648, 128, 2147483648, 32778, 0, 2147483658, 2147483648,
        2147516545, 2147483648, 32896, 2147483648, 2147483649, 0, 2147516424, 2147483648};
    unsigned int blocks[100], s[100];
    const int bits=256;

    unsigned int block, code, end = false, index = 0, start = 0,
        n, i, h, l, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, 
        b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15, b16, b17, 
        b18, b19, b20, b21, b22, b23, b24, b25, b26, b27, b28, b29, b30, b31, b32, b33, 
        b34, b35, b36, b37, b38, b39, b40, b41, b42, b43, b44, b45, b46, b47, b48, b49;
    const int blockCount = (1600 - bits * 2) / 32;
    const int byteCount = blockCount * 4;
    ...
    do {
        ...
        for (i = start;index < length && i < byteCount; ++index) {
            ...
            if (code < 0x80) {
                ...
                code = 0x10000 + (((code & 0x3ff) << 10) | (str[++index] & 0x3ff));
        ...
        for(n = 0; n < 48; n += 2) {
            ...
            if(file){
                std::string hex("");
                int nn;
                for(i = 0, nn = bits / 32;i < nn;++i) {
                    h = s[i];
                    hex += HEX_CHARS[(h >> 4) & 0x0F];
                    hex += HEX_CHARS[h & 0x0F];
                    hex += HEX_CHARS[(h >> 12) & 0x0F];
                    hex += HEX_CHARS[(h >> 8) & 0x0F];
                    hex += HEX_CHARS[(h >> 20) & 0x0F];
                    hex += HEX_CHARS[(h >> 16) & 0x0F];
                    hex += HEX_CHARS[(h >> 28) & 0x0F];
                    hex += HEX_CHARS[(h >> 24) & 0x0F];
                    hex += ' ';
                }
                fprintf(file,"%s\n",hex.c_str());
            }
...
/*
    ...
    */
    ...
    char* (*f[1])(const char* str, char* sha1, long long length, FILE* file, bool space)={SHA3_256};
    char fname[1][10]={"SHA3_256"};
